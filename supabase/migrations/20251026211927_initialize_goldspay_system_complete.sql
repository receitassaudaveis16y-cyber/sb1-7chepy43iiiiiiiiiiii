/*
  # Inicialização Completa do Sistema GoldsPay para Bolt.new e CloudPanel
  
  ## Tabelas Criadas
  - admin_roles, company_profiles, wallets, transactions, customers
  - api_keys, webhooks, platform_settings, activity_logs
  - fraud_detection_rules, payment_splits, notification_templates
  - compliance_documents, rate_limits, reconciliation_reports
  - payout_batches, settlement_schedule
  
  ## Funcionalidades
  - Função `promote_to_super_admin()` para criar primeiro admin
  - Trigger automático para criar wallet ao criar usuário
