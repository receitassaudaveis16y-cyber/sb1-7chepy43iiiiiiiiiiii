/*
  ...
  - Sistema de aprovação: account_status (pending, approved, rejected)
  ...
  ### 9. admin_roles
  - Controle de papéis administrativos
  - Define quem pode aprovar/rejeitar cadastros

  ## Segurança
  - Todas as tabelas possuem RLS habilitado
  - Políticas restritivas garantindo acesso apenas aos dados do próprio usuário
  - Admins têm acesso total aos dados para aprovação
...
-- Criar tabela admin_roles primeiro
...
CREATE INDEX IF NOT EXISTS idx_company_profiles_account_status ON company_profiles(account_status);
